  ...
  return (
    ...
    >
      ...
      <div className="
        ...
        before:opacity-30 group-hover:before:opacity-100 transition-opacity duration-500
      ">
        <div className="w-full h-full bg-[#050416] rounded-[31px]"></div>
      </div>

      {/* 2. GRADIENTES DE FONDO */}
      <div className="absolute -top-6 -left-6 w-28 h-28 bg-[#29D9C2] opacity-[0.1] blur-[45px] pointer-events-none group-hover:opacity-[0.20] transition-opacity duration-500" />
      <div className="absolute -bottom-6 -right-6 w-24 h-24 bg-[#62489A] opacity-[0.05] blur-[40px] pointer-events-none group-hover:opacity-[0.15] transition-opacity duration-500" />
