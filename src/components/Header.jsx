        ...
        <div className="max-w-[1440px] mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center gap-4 xl:gap-8">
            <ul className="flex gap-6 xl:gap-10 items-center font-poppins flex-nowrap">
              ...
              <li>
                <a href="#como-funciona" className="text-[13px] xl:text-sm text-white hover:text-cyan-400 transition-colors whitespace-nowrap">
                  Cómo funciona
                </a>
              </li>
              <li>
                <a href="#para-quien" className="text-[13px] xl:text-sm text-white hover:text-cyan-400 transition-colors whitespace-nowrap">
                  Para quién
                </a>
              </li>
            </ul>
