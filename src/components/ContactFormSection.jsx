...
const ContactFormSection = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(result.message || "Error enviando formulario")
      }
      ...
      <div className="max-w-[1100px] mx-auto px-6 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mt-14 md:mt-16 items-center">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 text-left">
            ...
            <button
              disabled={loading}
              className="w-full mt-6 py-3 md:py-4 rounded-full text-white font-semibold bg-gradient-to-r from-cyan-500 to-teal-400"
            >
      ...
      <div className="mt-20 md:mt-24 border-t border-white/10 pt-6 px-6">
        ...
        <div className="max-w-[1100px] mx-auto flex flex-col md:flex-row items-center justify-between gap-6 text-sm text-gray-300">
          ...
          <div className="flex items-center gap-6">
            <a href="https://smartjob.cl" className="hover:text-cyan-400">
              Smartjob.cl
            </a>

            <a href="#formulario" className="hover:text-cyan-400">
              Contacto
            </a>
          </div>
